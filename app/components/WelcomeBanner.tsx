        ...
        <div className="px-4 md:px-6 lg:px-8 relative z-10 mb-3">
            ...
            {!isLoading && primaryBanners.length > 0 && (
                <div className="mb-6 group relative pt-4">
                    <div className="relative overflow-hidden rounded-2xl shadow-2xl border border-white/5 bg-[#1E1E1E]">
                        {/* Banner Image */}
                        <div
            ...
            {!isLoading && secondaryBanners.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {secondaryBanners.map((banner) => (
                        <div
                            key={banner._id}
                            className="relative w-full aspect-[21/9] md:aspect-[16/7] rounded-xl overflow-hidden cursor-pointer group shadow-lg border border-white/5 bg-[#1E1E1E] hover:border-[#7F8CAA]/30 transition-all"
            ...
            {/* Loading State */}
            {isLoading && (
                <div className="w-full aspect-[21/9] md:aspect-[21/7] bg-[#1E1E1E] animate-pulse rounded-2xl" />
            )}
        </div>
    );
}
